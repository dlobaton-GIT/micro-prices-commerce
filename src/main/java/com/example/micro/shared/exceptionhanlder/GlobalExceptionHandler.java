...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleServletRequestBindingException(
        ...
        return buildResponseEntity(
                ...
                ServiceStatus.BAD_REQUEST.getMessage(),
    ...
    public ResponseEntity<Object> handleTimeoutException(final java.util.concurrent.TimeoutException ex) {
        ...
        return buildResponseEntity(
                ...
                Map.of("Error message", ServiceStatus.CONFLICT.getMessage()));
    ...
    private ResponseEntity<Object> buildResponseEntity(
        ...
        final ServiceErrorDto errorResponse = new ServiceErrorDto(HttpStatus.BAD_REQUEST.value(), message, errorDetails);
